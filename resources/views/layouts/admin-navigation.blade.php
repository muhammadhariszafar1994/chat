                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div>{{ config('panel.available_languages')[app()->getLocale()] }}</div>
                    ...
                    <x-slot name="content">
                        @foreach(config('panel.available_languages') as $langLocale => $langName)
                            <x-dropdown-link :href="route('set-language', ['locale' => $langLocale])">
                                {{ $langName }}
                            </x-dropdown-link>
                        @endforeach
                    </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <x-dropdown align="left" width="48">
                <x-slot name="trigger">
                    <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                        <div class="font-medium text-base text-gray-800">{{ config('panel.available_languages')[app()->getLocale()] }}</div>
